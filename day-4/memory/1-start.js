...
// 🟢 LLMs are stateless 
// the GMT time Tool function failed 33% of the times
// how was the AI agent able to remember that the previous tool call failed and needed to try again?
...
const result = await runnable.invoke({
  messages: [
    ...
    new HumanMessage(
      "Is is ok to call now a friend who lives in Berlin? Wonder what is the time there?"
    ),
  ]
})
